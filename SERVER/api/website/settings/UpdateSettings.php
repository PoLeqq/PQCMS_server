...
if(!empty($_POST["login_session_time"])) $settings->resetLoginSessionTime();
else $settings->setLoginSessionTime($_POST["login_session_time"]);

die(json_encode(["suc" => 1, "desc" => "Zmieniono ustawienia strony!"],JSON_UNESCAPED_UNICODE));