...
{
    $_SESSION["pqcms-client-announce-panel"] = ["err" => "Nieprawidłowy token."];
    header("location: ../");
    die("Nieprawidłowe przekierowanie. ".$_SESSION["pqcms-client-announce-panel"]["err"]);
}
...
{
    $_SESSION["pqcms-client-announce-panel"] = ["err" => "Wypełnij wszystkie pola!"];
    header("location: ../");
    die("Nieprawidłowe przekierowanie. ".$_SESSION["pqcms-client-announce-panel"]["err"]);
}
...
{
    $_SESSION["pqcms-client-announce-panel"] = ["err" => "Login musi mieć od 5 do 30 znaków!"];
    header("location: ../");
    die("Nieprawidłowe przekierowanie. ".$_SESSION["pqcms-client-announce-panel"]["err"]);
}
...
{
    $_SESSION["pqcms-client-announce-panel"] = ["err" => "Nazwa użytkownika musi mieć od 5 do 30 znaków!"];
    header("location: ../");
    die("Nieprawidłowe przekierowanie. ".$_SESSION["pqcms-client-announce-panel"]["err"]);
}
...
{
    $_SESSION["pqcms-client-announce-panel"] = ["err" => "Hasło musi mieć od 8 do 40 znaków!"];
    header("location: ../");
    die("Nieprawidłowe przekierowanie. ".$_SESSION["pqcms-client-announce-panel"]["err"]);
}
