...
if(!isset($_POST["pqcms-domain"]) || !isset($_POST["pqcms-username"]) || !isset($_POST["pqcms-license-key"]) || !isset($_POST["ip"]))
...
$response = checkLicense($_POST["ip"],$_SERVER["HTTP_REFERER"],$_POST["pqcms-domain"],$_POST["pqcms-username"],$_POST["pqcms-license-key"]);
