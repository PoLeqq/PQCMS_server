...
// SKRYPT ODKRYWA, GDZIE UŻYTKOWNIK "WYLĄDUJE" PO KLIKNIĘCIU NA LINK
// Np. domena.pl/dhlggfdhskdfdhkjf przekieruje na stronę domena.pl/404 ($finalUrl)

// $url="https://poleq.pl/ppp/httpreferer.php";
// $ch = curl_init();
